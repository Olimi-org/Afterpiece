...
type SvcMultiUploadRequest struct {
	Avatar     *any   `encore:"file"`
	Background *any   `encore:"file"`
	Username   string `json:"username"`
	Bio        string `json:"bio"`
}

// SingleUploadRequest contains a single file upload with metadata.
type SvcSingleUploadRequest struct {
	File  *any   `encore:"file"`
	Title string `json:"title"`
}

type SvcUploadResponse struct {
	URL      string `json:"url"`
