...
export namespace svc {
    ...
    export class ServiceClient {
         ...
         */
        public async MultiUpload(params: MultiUploadRequest): Promise<UploadResponse> {
            const formData = new FormData()
            formData.append("Avatar", params.Avatar)
            formData.append("Background", params.Background)
            if (params.username !== undefined) formData.append("username", JSON.stringify(params.username))
            if (params.bio !== undefined) formData.append("bio", JSON.stringify(params.bio))

            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/svc.MultiUpload`, formData)
         ...
         */
        public async SingleUpload(params: SingleUploadRequest): Promise<UploadResponse> {
            const formData = new FormData()
            formData.append("File", params.File)
            if (params.title !== undefined) formData.append("title", JSON.stringify(params.title))

            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/svc.SingleUpload`, formData)
            return await resp.json() as UploadResponse
        }
    }
}
